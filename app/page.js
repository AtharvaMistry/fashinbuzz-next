        ...
        <div className="grid px-5 mt-5 md:px-10">
          <div className="stats shadow bg-[#B2C8BA] min-w-full">
            <div className="stat">
              ...
              <div className="text-[#333333] text-2xl font-semibold">25.6K</div>
            </div>
            ...
            <div className="stat">
              ...
              <div className="text-[#333333] text-2xl font-semibold">Fast delivery</div>
              <div className="stat-desc text-[#333333]">Within few days</div>
            </div>

            <div className="stat">
              <div className="stat-value text-[#333333]">100</div>
              <div className="stat-desc text-[#333333]">Minimum order quantity</div>
            </div>
