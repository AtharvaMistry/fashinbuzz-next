...
function Page() {
  ...
  const handleBlogDelete = async (blogId) => {
    try {
      ...
      // const res = await fetch(`http://fashinbuzz.com/api/blog/${blogId}`);
      const res = await fetch(`http://fashinbuzz.com/api/blog?id=${blogId}`, {
        method: "DELETE",
        headers: {
          id: blogId,
        },
  ...
  const handleBlogUpdate = async (blogId) => {
    try {
      ...
      const res = await fetch(
        `http://fashinbuzz.com/api/blog/id?id=${blogId}`,
        {
          method: "PUT",
          headers: {
