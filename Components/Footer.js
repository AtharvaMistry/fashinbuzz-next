            ...
            <footer class="bg-[#B2C8BA]  dark:bg-gray-900">
                <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div class="px-5 sm:flex sm:items-center sm:justify-between md:px-10">
                        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">FashinBuzz™</a>. All Rights Reserved.
                        </span>
